...
final class RootShell {
    ...
    /** Runs [cmd] WITHOUT root, returning trimmed stdout or null. Nothing
     *  to do with the persistent session: this is the unprivileged probe
     *  path, used to answer "is ADB already on" on a panel where root was
     *  never granted, and spawning a plain process for it costs no
     *  Superuser grant at all. */
